...
import (
	...
	"cncos.io/box-controller/pkg/box-generated/clientset/versioned/scheme"
...
func (c *CncosV1alpha1Client) Boxes(namespace string) BoxInterface {
	return newBoxes(c, namespace)
}
