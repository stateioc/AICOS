...
import (
	...
	"cncos.io/box-controller/pkg/boxdeployment-generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CncosV1alpha1Interface interface {
	RESTClient() rest.Interface
	BoxDeploymentsGetter
}
...
func (c *CncosV1alpha1Client) BoxDeployments(namespace string) BoxDeploymentInterface {
	return newBoxDeployments(c, namespace)
}
