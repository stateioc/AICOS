...
# uninstall cri-rumtime flow script
VERSION="1.0.0"
PROGRAM="$(basename "$0")"
...
main() {
  ...
  utils::log "INFO" "removeing ${cri_type}"
  case ${cri_type,,} in
    "containerd")
      "${ROOT_DIR}"/k8s/uninstall_containerd
      ;;
    "docker")
  ...
  utils::log "OK" "removeing ${cri_type}"
}
