...
MIDDLEWARE.remove("blueapps.account.middlewares.RioLoginRequiredMiddleware")
MIDDLEWARE.remove("blueapps.account.middlewares.WeixinLoginRequiredMiddleware")
MIDDLEWARE.remove("blueapps.account.middlewares.LoginRequiredMiddleware")
